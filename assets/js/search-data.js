    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          title: '포트폴리오 <svg width="1.2rem" height="1.2rem" top=".5rem" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path d="M17 13.5v6H5v-12h6m3-3h6v6m0-6-9 9" class="icon_svg-stroke" stroke="#999" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
        
        description: "풀스택 개발자를 공부하고있는 강신혁 포트폴리오 입니다.",
        section: "Posts",
        handler: () => {
          
            window.open("https://lyounga1.github.io", "_blank");
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/lyounga1", "_blank");
        },
      },{
      id: 'light-theme',
